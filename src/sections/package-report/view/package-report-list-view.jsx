...
export function PackageReportListView() {
  const table = useTable();

  const dispatch = useAppDispatch();

  const { packageReport } = useAppSelector(selectReport);
  ...
  const flattenedReport = packageReport?.package_debits || [];
      ...
      <CardHeader
        ...
        action={
          ...
          >
            ...
            <Label color="primary">
              Total Package debit: {packageReport?.total_package_debits || 0}
            </Label>
          </Box>
        }
      />
