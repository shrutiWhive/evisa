...
export function CreditReportListView() {
  const table = useTable();

  const dispatch = useAppDispatch();

  const { creditReport } = useAppSelector(selectReport);
  ...
  const flattenedReport = creditReport?.credits || [];
    ...
    <DashboardContent>
      ...
      <CardHeader
        ...
        action={
          ...
          >
            <Iconify icon="mdi:credit-card-chip" width={22} />
            <Label color="primary">
              Total Credits: {creditReport?.total_credits || 0}
            </Label>
          </Box>
        }
      />
